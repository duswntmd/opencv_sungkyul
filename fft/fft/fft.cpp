...
int main(int argc, char* argv[])
{
	...
	output_img = (uchar**)uc_alloc(COL, ROW);
	...
	for (i = 0; i < ROW; i++)
		for (j = 0; j < COL; j++)
		{
			...
			output_img[i][j] = (uchar)fourier_img[i][j];
		}
